...
<!-- Mirrored from templates.envytheme.com/startp/default/repair-index.html by HTTrack Website Copier/3.x [XR&CO'2017], Tue, 19 Dec 2023 16:45:34 GMT -->
<head>
		<!-- Required meta tags -->
		<meta charset="utf-8">
			...
			<div class="startp-nav">
				<div class="container">
					<nav class="navbar navbar-expand-md navbar-light">
						<a class="navbar-brand black-logo" href="repair-index.html"><img src="assets/img/logo.png" alt="logo"></a>
						<a class="navbar-brand white-logo" href="repair-index.html"><img src="assets/img/white-logo.png" alt="logo"></a>
							...
							<ul class="navbar-nav nav ml-auto">
								<li class="nav-item"><a href="#" class="nav-link active">Home <i data-feather="chevron-down"></i></a>
									<ul class="dropdown_menu">
										...
										<li class="nav-item"><a href="#" class="nav-link active">Home Four <i data-feather="chevron-right"></i></a>
											<ul class="dropdown_menu">
												<li class="nav-item"><a href="repair-index.html" class="nav-link active">Light Green</a></li>
                    ...
                    <div class="col-lg-6">
                        <div class="repair-about-content">
                            ...
                            <ul>
                                ...
                                <li><span><i data-feather="check"></i> Excellent Reputation</span></li>
				...
				<div class="row">
					...
					<div class="col-lg-3 col-md-6 col-sm-6">
						<div class="single-footer-widget">
							...
							<ul class="footer-contact-info">
								...
								<li><i data-feather="mail"></i> Email: <a href="../../../external.html?link=https://templates.envytheme.com/cdn-cgi/l/email-protection#3b535e5757547b484f5a494f4b15585456"><span class="__cf_email__" data-cfemail="345c5158585b744740554640441a575b59">[email&#160;protected]</span></a></li>
					...
					<div class="col-lg-12 col-md-12">
						<div class="copyright-area">
							<p>Copyright @<script data-cfasync="false" src="../../cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script>document.write(new Date().getFullYear())</script> StartP. All Rights Reserved by <a href="../../../external.html?link=https://envytheme.com/" target="_blank">EnvyTheme</a></p>
						</div>
					</div>
				</div>
			</div>
...
<!-- Mirrored from templates.envytheme.com/startp/default/repair-index.html by HTTrack Website Copier/3.x [XR&CO'2017], Tue, 19 Dec 2023 16:49:48 GMT -->
</html>